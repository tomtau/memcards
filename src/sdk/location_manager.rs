...
impl LayoutManager {
    ...
    /// Show a reference card with title and content
    ...
    pub fn show_dashboard_card(
        ...
        DisplayRequest {
            ...
            package_name: self.package_name.clone(),
            session_id: self.session_id.clone(),
            view: view.unwrap_or(ViewType::Dashboard),
    ...
    /// Show a bitmap view with base64 encoded data
    pub fn show_bitmap_view(
        &self,
        ...
        if data.len() > 1_000_000 {
            warn!(
                "⚠️ Bitmap data is very large ({}), this may cause performance issues",
                data.len()
            );
        }
